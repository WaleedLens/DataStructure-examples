...
public class LinkedListDequeTest {
    ...
    @Test
    /** This test checks if LinkedListDeque organize elements in correct format */
    public void addedOnOrderTest(){

        Deque<Integer> orderList = new LinkedListDeque<>();

        orderList.addFirst(1);
        orderList.addFirst(2);
        orderList.addFirst(3);
        orderList.addLast(4);
        orderList.addLast(5);
        orderList.addFirst(6);
        assertThat(orderList.toList()).containsExactly(6,3,2,1,4,5).inOrder();
    ...
    public void removeLastTest(){
        ...
        assertThat(list.get(list.toList().size()-1)).isEqualTo(2);
